...
$isDev = (strpos(strtolower(App::env('ENVIRONMENT') ?? App::env('CRAFT_ENVIRONMENT')), 'dev') !== false) ? true : false;
...
return [
     ...
     */
    'manifestPath' => App::parseEnv('@webroot') . '/dist/manifest.json',
     ...
     */
    'criticalPath' => App::parseEnv('@webroot') . '/dist/criticalcss',
